...
import SprayRepository from "../../repositories/pulverization.repository";
import { PulverizationEntity } from "./pulverization.entity";
import SprayService from "./pulverization.service";
...
export default class ProcessGuideController {
  ...
  public async SaveSpray(
    ...
    try {
      const newSpray: PulverizationEntity = request.body;
